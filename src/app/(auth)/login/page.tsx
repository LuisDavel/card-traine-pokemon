...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-pk-dark flex relative overflow-hidden">
      {/* BG Pokeballs */}
      <Pokeball size={250} color="rgba(220,38,38,0.04)" className="absolute -top-20 -right-20 animate-pokeball-spin" />
      <Pokeball size={180} color="rgba(220,38,38,0.03)" className="absolute bottom-10 -left-16 animate-pokeball-spin" style={{ animationDirection: "reverse" }} />
      <Pokeball size={100} color="rgba(220,38,38,0.04)" className="absolute top-1/2 right-1/4 animate-pokeball-float" />
      ...
      <div className="hidden lg:flex flex-1 flex-col items-center justify-center relative">
        <div className="text-center">
          ...
          <p className="text-pk-text-muted max-w-xs">
            Seu cracha de treinador Pokemon digital com efeitos 3D
          </p>
        </div>
      </div>
